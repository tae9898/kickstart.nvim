...
-- i don't wanna save at clipboard when i use 's'
...
local search_highlight_group = vim.api.nvim_create_augroup('search-highlight', { clear = true })
...
require('lazy').setup({
  ...
  -- need nvim-cmp also
  {
    ...
    lazy = false,  -- 즉시 로드하여 cmp 순환 참조 방지
    config = function()
  ...
  --Change the world! oh i mean word
  {
  ...
  },
{
  ...
  -- install harpoon actually i don't use :(
  {
    'ThePrimeagen/harpoon',
    branch = 'harpoon2',
    dependencies = { 'nvim-lua/plenary.nvim' },
  },
{
  ...
  --  require('notebook').setup(), -- for jup
